...
<main class="app-main">
        ...
        <div class="row p-4">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-end">
                  <li class="breadcrumb-item"><a href="<?=$base;?>editarEscolar">Home</a></li>
    ...
    <tbody>
        ...
        foreach ($unidades as $unidade): ?>
            <tr id="escola<?= $unidade['id']; ?>">
            <td><?= mb_strtoupper($unidade['nomeUnidade'], 'UTF-8'); ?></td>
                ...
                <td>
                    <a href="#" class="btn btn-success" title="Visualizar">
                        <i class="bi bi-eye"></i>
                    </a>
                    <a href="<?= $base; ?>unidade/editar/<?= $unidade['id']; ?>" class="btn btn-warning" title="Editar">
