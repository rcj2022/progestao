            ...
            <tbody>
              <tr>
                ...
                for ($i = $firstDay; $i < 7; $i++) {
                  ...
                  echo "<td class=\"$class\" style='cursor:pointer;' onclick='abrirModal($day)'>$day</td>";
                  $day++;
                }
                echo "</tr>";
        ...
        <tbody>
          <?php foreach ($evento as $evento): ?>
            ...
            <td><?=date('d/m/Y', strtotime  ($evento['dataFinal'])); ?></td>
              <td>
              <button type="button" class="btn btn-danger"> <a title="Excluir Pessoa" href="#" onclick="ExcluirEvento(<?=$evento['id'];?>)" class="text-light" ><i class="bi bi-trash"></i>
              </a></button>
              </td>
            </tr>
          <?php endforeach; ?>
...
<form method="post" action="evento/add"> <!-- Substitua pelo seu arquivo de backend -->
  <div class="modal-content">
    ...
    <div class="modal-body">
      ...
      <input type="hidden" name="dia_clicado" id="diaSelecionado">
    </div>
...
<!-- Script para abrir modal e preencher data -->
<script>
...
document.getElementById('diaSelecionado').value = data;
