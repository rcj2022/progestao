<footer class="app-footer">
        <!--begin::To the end-->
        <div class="float-end d-none d-sm-inline">Só Jesus salva!</div>
        <!--end::To the end-->
        <!--begin::Copyright-->
        <strong>
          Copyright &copy; 2025&nbsp;
          <a href="https://manoelbarreto.com.br" class="text-decoration-none">Manoel Barreto</a>.
        </strong>
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js"></script>
    ...
    <script src="<?=$base?>assets/js/funcoes.js"></script>    
