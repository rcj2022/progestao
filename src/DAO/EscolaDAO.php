...
class EscolaDAO {
    ...
    public function editarInfoUnidade($id, $atocriacao ,$decretocriacao, $decretoAutorizacao, $diretorUnidade, $cpfDiretor, $decretoDiretor, $secretarioUnidade, $cpfSecretario, $decretoSecretario, $especialistaUnidade,  $cpfEspecialista){
    ...
    public function AtualizarEnderecoUnidade( $id, $cep,  $endereco,  $numero, $bairro, $pais,  $uf,  $ufNome, $cidade){
        $id = $_SESSION['idescola'];
