...
class EscolaController extends Controller {
    ...
    public function editarInfoEscola(){
        ...
        $id = $_SESSION['idescola'];
             ...
             $data=$pessoaDAO->editarInfoUnidade( $id, $atocriacao, $decretocriacao, $decretoAutorizacao, $diretorUnidade, $cpfDiretor, $decretoDiretor, $secretarioUnidade, $cpfSecretario, $decretoSecretario, $especialistaUnidade,  $cpfEspecialista);
     
             $this->redirect('escola');
         }

         public function editarEnderecoEscola(){
            ...
            $id = $_SESSION['idescola'];
                ...
                $cep = filter_input(INPUT_POST, 'cep'); 
                 ...
                 $data=$pessoaDAO->AtualizarEnderecoUnidade( $id, $cep,  $endereco,  $numero, $bairro, $pais,  $uf,  $ufNome, $cidade
                 );
